...
pub fn build_terrain(world_size : Size, max_length : f32) -> Vec::<Position>{    
    ...
    points.push( Position{ x:world_size.x, y:world_size.y}  );
    points
}